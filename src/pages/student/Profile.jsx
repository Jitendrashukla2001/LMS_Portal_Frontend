...
// import { useLoadUserQuery, useUpdateProfileMutation } from '@/features/api/authapi'
...
//   const [updateProfile, { data: updateUserData, isLoading: updateUserIsLoading, error }] = useUpdateProfileMutation();
...
//           <Avatar className='w-24 h-24 md:h-32 md:w-32 rounded-full mb-4'>
...
//                   Edit Profile
//                 </DialogTitle>
//                 <DialogDescription>Make changes to your here .Click to save when you are done.</DialogDescription>
//               </DialogHeader>
...
//                   {
//                     isLoading ? (<>
//                       <Loader2 className='mr-4 h-4 w-4 animate-spin'>Please wait</Loader2></>) : "Save Changes"
//                   }
//                 </Button>
//               </DialogFooter>
//             </DialogContent>
...
//               user.enrolledCourses.map((course) => <Course course={course} key={course._id}></Course>
//               ))
//           }
//         </div>
//       </div>
...
const Profile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 mt-16 my-10">
      <h1 className="font-bold text-2xl text-center md:text-left">PROFILE</h1>
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 my-5">
        <div className="flex flex-col items-center">
